...
export const AboutUsPage: React.FC = () => {
  return (
    <div className="space-y-16 sm:space-y-24 pb-16 sm:pb-24">
      <section className="bg-charcoal text-parchment py-16 sm:py-24 text-center px-4 sm:px-6">
        <div className="max-w-3xl mx-auto space-y-3 sm:space-y-4">
          <span className="text-xs uppercase tracking-[0.3em] text-brass font-bold">Heritage & Soul</span>
          <h1 className="text-3xl sm:text-5xl md:text-6xl font-serif font-bold tracking-wide">The Stitch & Crafts Atelier</h1>
      ...
      <section className="max-w-6xl mx-auto px-4 sm:px-6 grid grid-cols-1 md:grid-cols-2 gap-10 sm:gap-16 items-center">
        <div className="aspect-[4/3] bg-gray-100 overflow-hidden shadow-lg border border-gray-200 rounded-xl">
          <img
        ...
        <div className="space-y-4 sm:space-y-6">
          ...
          <div className="pt-2 sm:pt-4">
            <Link to="/shop" className="inline-block bg-leather text-white px-8 py-3.5 text-xs font-bold uppercase tracking-widest hover:bg-leather-dark transition rounded shadow-sm">
